...
<h3>Allot third party driver for customers</h3>
${mymsg}
<c:url value="saveCustUrl" var="/admin/spare/allot"/>
<form:form modelAttribute="booking" method="POST" action="${saveCustUrl}">
<table   cellpadding="10">
<tr>
	<td><form:label path="b_id">Booking Id</form:label></td>
	<td><form:input path="b_id"/></td><td><form:errors path="b_id"/></td>
</tr>
<tr>
	<td><form:label path="spareD.id">Spare Driver </form:label></td>
	<td><form:input path="spareD.id"/></td><td><form:errors path="spareD.id"/></td>
</tr>
